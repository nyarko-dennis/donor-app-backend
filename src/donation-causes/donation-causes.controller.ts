...
export class DonationCausesController {
  ...
  @ApiResponse({
    status: 200,
    description: 'List of all donation causes.',
    type: PageDto<DonationCauseResponseDto>,
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'The donation cause.',
    type: DonationCauseResponseDto,
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'The updated donation cause.',
    type: DonationCauseResponseDto,
  })
  update(
    @Param('id') id: string,
    @Body() updateDonationCauseDto: Partial<CreateDonationCauseDto>,
  ) {
