...
export class DonorsController {
  ...
  @ApiResponse({
    status: 201,
    description: 'The donor has been successfully created.',
  ...
  @ApiResponse({
    status: 200,
    description: 'Return all donors.',
    type: PageDto<DonorResponseDto>,
  })
  async findAll(
    @Query() pageOptionsDto: DonorsPageOptionsDto,
  ): Promise<PageDto<DonorResponseDto>> {
  ...
  @ApiResponse({
    status: 200,
    description: 'The donor has been successfully deleted.',
  })
